...
public class NWEventsNotificationSpecificActivity extends AppCompatActivity {
...
//        });
        ...
        category1TextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NWEventsNotificationSpecificActivity.this,NWEventsNotification1DescriptionActivity.class);
                startActivity(intent);
            }
        });
        ...
        category2TextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NWEventsNotificationSpecificActivity.this, NWEventsNotification2DescriptionActivity.class);
                startActivity(intent);
            }
        });
